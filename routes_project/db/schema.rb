...
ActiveRecord::Schema[7.0].define(version: 2023_08_18_015547) do
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["image_url", "artist_id", "title"], name: "index_artworks_on_image_url_and_artist_id_and_title", unique: true
  end
